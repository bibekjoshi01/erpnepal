...
from erpnepal.accounts.party import render_address
from erpnepal.controllers.accounts_controller import get_taxes_and_charges
from erpnepal.controllers.sales_and_purchase_return import get_rate_for_return
from erpnepal.controllers.stock_controller import StockController
from erpnepal.stock.doctype.item.item import set_item_default
from erpnepal.stock.get_item_details import get_bin_details, get_conversion_factor
from erpnepal.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from erpnepal.accounts.party import _get_party_details
			...
			from erpnepal.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from erpnepal.controllers.buying_controller import validate_item_type
