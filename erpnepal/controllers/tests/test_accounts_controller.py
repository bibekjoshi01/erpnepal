...
class TestAccountsController(IntegrationTestCase):
	...
	def setup_dimensions(self):
		# create dimension
		from erpnepal.accounts.doctype.accounting_dimension.test_accounting_dimension import (
			create_dimension,
		)
	...
	def test_party_billing_and_shipping_address(self):
		from erpnepal.crm.doctype.prospect.test_prospect import make_address
