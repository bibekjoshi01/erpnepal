...
from erpnepal.accounts.doctype.budget.budget import validate_expense_against_budget
from erpnepal.accounts.party import get_party_details
from erpnepal.buying.utils import update_last_purchase_rate, validate_for_items
...
from erpnepal.stock.get_item_details import get_conversion_factor, get_item_defaults
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from erpnepal.controllers.budget_controller import BudgetValidation
