...
from erpnepal.setup.doctype.employee.employee import get_holiday_list_for_employee
from erpnepal.stock.doctype.serial_no.serial_no import get_serial_nos
from erpnepal.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.maintenance.doctype.maintenance_schedule_detail.maintenance_schedule_detail import (
			MaintenanceScheduleDetail,
		)
		from erpnepal.maintenance.doctype.maintenance_schedule_item.maintenance_schedule_item import (
