...
erpnepal.landed_cost_taxes_and_charges.setup_triggers("Subcontracting Receipt");
				...
				frm.add_custom_button(
					...
					() => {
						frappe.model.open_mapped_doc({
							method: "erpnepal.subcontracting.doctype.subcontracting_receipt.subcontracting_receipt.make_purchase_receipt",
							frm: frm,
							freeze: true,
			...
			frm.add_custom_button(
				...
				() => {
					const make_standard_return = () => {
						frappe.model.open_mapped_doc({
							method: "erpnepal.subcontracting.doctype.subcontracting_receipt.subcontracting_receipt.make_subcontract_return",
							frm: frm,
						});
					};
						...
						frappe.prompt(
							...
							function (values) {
								if (values.return_for_rejected_warehouse) {
									frappe.call({
										method: "erpnepal.subcontracting.doctype.subcontracting_receipt.subcontracting_receipt.make_subcontract_return_against_rejected_warehouse",
										args: {
