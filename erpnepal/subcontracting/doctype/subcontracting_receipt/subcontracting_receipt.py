...
from erpnepal.controllers.subcontracting_controller import SubcontractingController
...
from erpnepal.stock.get_item_details import get_default_cost_center, get_default_expense_account
from erpnepal.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.subcontracting.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from erpnepal.subcontracting.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		...
		if not erpnepal.is_perpetual_inventory_enabled(self.company):
			return []
