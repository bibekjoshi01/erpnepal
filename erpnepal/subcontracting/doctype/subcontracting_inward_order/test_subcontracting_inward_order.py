...
from erpnepal.manufacturing.doctype.work_order.work_order import make_stock_entry as make_stock_entry_from_wo
from erpnepal.selling.doctype.sales_order.sales_order import make_subcontracting_inward_order
...
class IntegrationTestSubcontractingInwardOrder(IntegrationTestCase):
	...
	def test_rm_return(self):
		from erpnepal.stock.serial_batch_bundle import get_batch_nos, get_serial_nos
	...
	def test_subcontracting_delivery(self):
		from erpnepal.stock.serial_batch_bundle import get_serial_batch_list_from_item
...
def make_service_items():
	from erpnepal.controllers.tests.test_subcontracting_controller import make_service_item
