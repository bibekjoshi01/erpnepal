...
from erpnepal.projects.doctype.task.task import CircularReferenceError, ParentIsGroupError
from erpnepal.tests.utils import ERPNepalTestSuite


class TestTask(ERPNepalTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_overdue(self):
		...
		from erpnepal.projects.doctype.task.task import set_tasks_as_overdue
