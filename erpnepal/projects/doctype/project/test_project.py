...
from erpnepal.projects.doctype.project_template.test_project_template import make_project_template
from erpnepal.projects.doctype.task.test_task import create_task
from erpnepal.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(ERPNepalTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
		cls.make_projects()
	...
	def test_project_total_costing_and_billing_amount(self):
		from erpnepal.projects.doctype.timesheet.test_timesheet import make_timesheet
