...
from erpnepal.controllers.taxes_and_totals import get_itemised_tax
from erpnepal.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"erpnepal/regional/italy/e-invoice.xml",
