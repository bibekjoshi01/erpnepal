...
import erpnepal
from erpnepal.accounts.utils import get_currency_precision, get_stock_accounts
from erpnepal.stock.doctype.stock_reposting_settings.stock_reposting_settings import get_stock_ledgers
from erpnepal.stock.doctype.warehouse.warehouse import get_warehouses_based_on_account


def execute(filters=None):
	if not erpnepal.is_perpetual_inventory_enabled(filters.company):
		frappe.throw(
