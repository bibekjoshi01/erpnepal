...
from erpnepal.stock.doctype.stock_closing_entry.stock_closing_entry import StockClosing
from erpnepal.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from erpnepal.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from erpnepal.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = erpnepal.get_company_currency(self.filters.get("company"))
		else:
