...
import erpnepal
from erpnepal.accounts.general_ledger import validate_accounting_period
from erpnepal.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from erpnepal.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(erpnepal.is_perpetual_inventory_enabled(doc.company)):
		return
...
def execute_repost_item_valuation():
	...
	method = "erpnepal.stock.doctype.repost_item_valuation.repost_item_valuation.repost_entries"
	if frappe.db.get_single_value("Stock Reposting Settings", "enable_parallel_reposting"):
		method = "erpnepal.stock.doctype.repost_item_valuation.repost_item_valuation.run_parallel_reposting"
