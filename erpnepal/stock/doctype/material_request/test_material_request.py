...
# ERPNepal - web based ERP (http://erpnepal.com)
...
from erpnepal.stock.doctype.stock_entry.stock_entry import make_stock_in_entry
...
class TestMaterialRequest(IntegrationTestCase):
	...
	def test_partial_make_stock_entry(self):
		from erpnepal.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry as _make_stock_entry
	...
	def test_auto_email_users_with_company_user_permissions(self):
		from erpnepal.stock.reorder_item import get_email_list
	...
	def test_get_remaining_qty_from_sales_order(self):
		...
		from erpnepal.selling.doctype.sales_order.sales_order import make_material_request
		from erpnepal.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_pending_qty_in_pick_list(self):
		...
		from erpnepal.stock.doctype.pick_list.pick_list import create_stock_entry
