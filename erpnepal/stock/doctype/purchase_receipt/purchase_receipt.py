...
from erpnepal.assets.doctype.asset.asset import get_asset_account, is_cwip_accounting_enabled
from erpnepal.buying.utils import check_on_hold_or_closed_status
from erpnepal.controllers.accounts_controller import merge_taxes
from erpnepal.controllers.buying_controller import BuyingController
from erpnepal.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def make_item_gl_entries(self, gl_entries, inventory_account_map=None):
		...
		for d in self.get("items"):
			...
			if (
				...
				if not (
					(erpnepal.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	...
	from erpnepal.accounts.party import get_payment_terms_template
