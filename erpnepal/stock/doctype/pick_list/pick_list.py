...
from erpnepal.stock.get_item_details import get_company_total_stock, get_conversion_factor
...
class PickList(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.stock.doctype.pick_list_item.pick_list_item import PickListItem
