...
from erpnepal.stock.serial_batch_bundle import get_serial_nos as get_serial_nos_from_bundle
from erpnepal.stock.valuation import FIFOValuation
...
def get_reserved_serial_nos_for_pos(kwargs):
	from erpnepal.controllers.sales_and_purchase_return import get_returned_serial_nos
