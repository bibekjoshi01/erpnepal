...
import erpnepal
from erpnepal.accounts.general_ledger import process_gl_map
from erpnepal.accounts.utils import get_account_currency
from erpnepal.buying.utils import check_on_hold_or_closed_status
from erpnepal.controllers.taxes_and_totals import init_landed_taxes_and_totals
from erpnepal.manufacturing.doctype.bom.bom import (
	add_additional_cost,
...
from erpnepal.setup.doctype.brand.brand import get_brand_defaults
from erpnepal.setup.doctype.item_group.item_group import get_item_group_defaults
from erpnepal.stock.doctype.batch.batch import get_batch_qty
from erpnepal.stock.doctype.item.item import get_item_defaults
...
from erpnepal.stock.serial_batch_bundle import (
	SerialBatchCreation,
	get_empty_batches_based_work_order,
	get_serial_or_batch_items,
)
from erpnepal.stock.stock_ledger import NegativeStockError, get_previous_sle, get_valuation_rate
from erpnepal.stock.utils import get_bin, get_combine_datetime, get_incoming_rate
...
from erpnepal.controllers.stock_controller import StockController
from erpnepal.controllers.subcontracting_inward_controller import SubcontractingInwardController
...
class StockEntry(StockController, SubcontractingInwardController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.stock.doctype.landed_cost_taxes_and_charges.landed_cost_taxes_and_charges import (
			LandedCostTaxesandCharges,
		)
		from erpnepal.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from erpnepal.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def validate_difference_account(self):
		if not cint(erpnepal.is_perpetual_inventory_enabled(self.company)):
			return
	...
	def set_actual_qty(self):
		from erpnepal.stock.stock_ledger import is_negative_stock_allowed
	...
	def validate_same_source_target_warehouse_during_material_transfer(self):
		...
		if frappe.get_single_value("Stock Settings", "validate_material_transfer_warehouses"):
			from erpnepal.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
		...
		for d in self.get("items"):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				...
				d.basic_rate = get_valuation_rate(
					...
					currency=erpnepal.get_company_currency(self.company),
					company=self.company,
	...
	def get_bom_raw_materials(self, qty):
		from erpnepal.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_pick_list_status(self):
		from erpnepal.stock.doctype.pick_list.pick_list import update_pick_list_status
...
def get_expired_batch_items():
	from erpnepal.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_auto_batch_nos
