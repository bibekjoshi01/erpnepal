...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from erpnepal.accounts.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
