...
from erpnepal.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from erpnepal.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from erpnepal.accounts.doctype.pos_invoice_reference.pos_invoice_reference import POSInvoiceReference
		from erpnepal.accounts.doctype.sales_invoice_reference.sales_invoice_reference import (
