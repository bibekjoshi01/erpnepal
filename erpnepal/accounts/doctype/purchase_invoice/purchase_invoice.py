...
from erpnepal.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
from erpnepal.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from erpnepal.accounts.party import get_due_date, get_party_account
from erpnepal.accounts.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
from erpnepal.assets.doctype.asset.asset import is_cwip_accounting_enabled
from erpnepal.assets.doctype.asset_category.asset_category import get_asset_category_account
from erpnepal.buying.utils import check_on_hold_or_closed_status
from erpnepal.controllers.accounts_controller import validate_account_head
from erpnepal.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from erpnepal.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from erpnepal.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from erpnepal.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from erpnepal.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, inventory_account_map=None):
		self.auto_accounting_for_stock = erpnepal.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from erpnepal.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_purchase_receipt(source_name, target_doc=None, args=None):
	...
	def update_item(obj, target, source_parent):
		from erpnepal.controllers.sales_and_purchase_return import get_returned_qty_map_for_row
