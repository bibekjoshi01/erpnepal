...
from erpnepal.accounts.party import get_dashboard_info
...
class TestLoyaltyProgram(IntegrationTestCase):
	...
	@unittest.mock.patch("erpnepal.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_details")
