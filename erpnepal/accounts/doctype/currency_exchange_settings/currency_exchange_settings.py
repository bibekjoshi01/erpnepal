...
class CurrencyExchangeSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.currency_exchange_settings_details.currency_exchange_settings_details import (
			CurrencyExchangeSettingsDetails,
		)
		from erpnepal.accounts.doctype.currency_exchange_settings_result.currency_exchange_settings_result import (
