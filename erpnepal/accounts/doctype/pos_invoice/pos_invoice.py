...
from erpnepal.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
...
from erpnepal.controllers.queries import item_query as _item_query
from erpnepal.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
...
def create_payments_on_invoice(doc, idx, payment_details):
	from erpnepal.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
