...
import erpnepal
from erpnepal.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from erpnepal.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from erpnepal.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from erpnepal.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from erpnepal.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from erpnepal.accounts.doctype.tax_withholding_entry.tax_withholding_entry import PaymentTaxWithholding
...
from erpnepal.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from erpnepal.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from erpnepal.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from erpnepal.accounts.doctype.payment_request.payment_request import (
	...
	def set_transaction_currency_and_rate(self):
		company_currency = erpnepal.get_company_currency(self.company)
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or erpnepal.get_company_currency(ref_doc.company)
