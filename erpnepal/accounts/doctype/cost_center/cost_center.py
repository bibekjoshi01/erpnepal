...
from erpnepal.accounts.utils import validate_field_number
...
class CostCenter(NestedSet):
	...
	def autoname(self):
		from erpnepal.accounts.utils import get_autoname_with_number
	...
	def before_rename(self, olddn, newdn, merge=False):
		...
		from erpnepal.setup.doctype.company.company import get_name_with_abbr
