...
from erpnepal.accounts.utils import OUTSTANDING_DOCTYPES, get_account_currency, get_fiscal_year
from erpnepal.exceptions import InvalidAccountCurrency, ReportingCurrencyExchangeNotFoundError
...
def update_against_account(voucher_type, voucher_no):
	...
	if not entries:
		return
	company_currency = erpnepal.get_company_currency(entries[0].company)
