...
from erpnepal.accounts.utils import sync_auto_reconcile_config
...
class AccountsSettings(Document):
	...
	def drop_ar_sql_procedures(self):
		from erpnepal.accounts.report.accounts_receivable.accounts_receivable import InitSQLProceduresForAR
