...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from erpnepal.accounts.doctype.shipping_rule_country.shipping_rule_country import (
			ShippingRuleCountry,
		)
