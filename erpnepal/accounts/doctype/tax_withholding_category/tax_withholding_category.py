...
from erpnepal import allow_regional
...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from erpnepal.accounts.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
