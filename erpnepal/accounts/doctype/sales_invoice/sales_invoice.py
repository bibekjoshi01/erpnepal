...
import erpnepal
from erpnepal.accounts.deferred_revenue import validate_service_stop_date
from erpnepal.accounts.doctype.loyalty_program.loyalty_program import (
	get_loyalty_program_details_with_points,
	validate_loyalty_points,
)
from erpnepal.accounts.doctype.pricing_rule.utils import (
	update_coupon_code_count,
	validate_coupon_code,
)
from erpnepal.accounts.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from erpnepal.accounts.doctype.tax_withholding_entry.tax_withholding_entry import SalesTaxWithholding
from erpnepal.accounts.general_ledger import get_round_off_account_and_cost_center
from erpnepal.accounts.party import get_due_date, get_party_account, get_party_details
from erpnepal.accounts.utils import (
	get_account_currency,
	update_voucher_outstanding,
)
from erpnepal.assets.doctype.asset.asset import split_asset
from erpnepal.assets.doctype.asset.depreciation import (
	depreciate_asset,
...
from erpnepal.assets.doctype.asset_activity.asset_activity import add_asset_activity
from erpnepal.controllers.accounts_controller import validate_account_head
from erpnepal.controllers.selling_controller import SellingController
from erpnepal.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from erpnepal.setup.doctype.company.company import update_company_current_month_sales
from erpnepal.stock.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.item_wise_tax_detail.item_wise_tax_detail import ItemWiseTaxDetail
		from erpnepal.accounts.doctype.payment_schedule.payment_schedule import PaymentSchedule
		from erpnepal.accounts.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from erpnepal.accounts.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from erpnepal.accounts.doctype.sales_invoice_item.sales_invoice_item import SalesInvoiceItem
		from erpnepal.accounts.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from erpnepal.accounts.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
			SalesInvoiceTimesheet,
		)
		from erpnepal.accounts.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from erpnepal.accounts.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from erpnepal.selling.doctype.sales_team.sales_team import SalesTeam
		from erpnepal.stock.doctype.packed_item.packed_item import PackedItem
	...
	def check_credit_limit(self):
		from erpnepal.selling.doctype.customer.customer import check_credit_limit
	...
	def set_pos_fields(self, for_validate=False):
		...
		from erpnepal.stock.get_item_details import (
			ItemDetailsCtx,
			get_pos_profile,
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			from erpnepal.stock.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from erpnepal.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries

		auto_accounting_for_stock = erpnepal.is_perpetual_inventory_enabled(self.company)
		if not gl_entries:
	...
	def get_gl_entries(self, inventory_account_map=None):
		from erpnepal.accounts.general_ledger import merge_similar_entries
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(self.update_stock) and erpnepal.is_perpetual_inventory_enabled(self.company):
	...
	def apply_loyalty_points(self):
		from erpnepal.accounts.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_list_context(context=None):
	from erpnepal.controllers.website_list_for_contact import get_list_context
...
def get_loyalty_programs(customer):
	...
	from erpnepal.selling.doctype.customer.customer import get_loyalty_programs
...
def create_dunning(source_name, target_doc=None, ignore_permissions=False):
	...
	def postprocess_dunning(source, target):
		from erpnepal.accounts.doctype.dunning.dunning import get_dunning_letter_text
