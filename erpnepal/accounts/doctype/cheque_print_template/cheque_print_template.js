...
frappe.provide("erpnepal.cheque_print");
	...
	refresh: function (frm) {
		if (!frm.doc.__islocal) {
			frm.add_custom_button(
				...
				function () {
					erpnepal.cheque_print.view_cheque_print(frm);
				}
...
erpnepal.cheque_print.view_cheque_print = function (frm) {
	frappe.call({
		method: "erpnepal.accounts.doctype.cheque_print_template.cheque_print_template.create_or_update_cheque_print_format",
		args: {
