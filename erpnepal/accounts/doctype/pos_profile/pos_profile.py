...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from erpnepal.accounts.doctype.pos_item_group.pos_item_group import POSItemGroup
		from erpnepal.accounts.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from erpnepal.accounts.doctype.pos_profile_user.pos_profile_user import POSProfileUser
