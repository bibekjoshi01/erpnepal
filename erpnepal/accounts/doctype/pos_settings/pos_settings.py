...
class POSSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.pos_field.pos_field import POSField
		from erpnepal.accounts.doctype.pos_search_fields.pos_search_fields import POSSearchFields
