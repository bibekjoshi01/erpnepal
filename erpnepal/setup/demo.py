...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "erpnepal")
	try:
		...
		capture("demo_data_creation_failed", "erpnepal", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "erpnepal")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "erpnepal")
	try:
...
def make_transactions(company):
	...
	from erpnepal.accounts.utils import FiscalYearError
