...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from erpnepal.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
			TransactionDeletionRecordItem,
		)
		from erpnepal.setup.doctype.transaction_deletion_record_to_delete.transaction_deletion_record_to_delete import (
