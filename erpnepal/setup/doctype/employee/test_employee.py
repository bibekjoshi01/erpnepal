...
import erpnepal
from erpnepal.accounts.utils import build_qb_match_conditions
from erpnepal.setup.doctype.employee.employee import InactiveEmployeeStatusError
		...
		employee = frappe.get_doc(
			{
				...
				"naming_series": "EMP-",
				"first_name": user,
				"company": company or erpnepal.get_default_company(),
				"user_id": user,
