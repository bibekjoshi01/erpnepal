...
from erpnepal.manufacturing.doctype.bom.bom import add_additional_cost, get_bom_items_as_dict
from erpnepal.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from erpnepal.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from erpnepal.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from erpnepal.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from erpnepal.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import JobCardScrapItem
		from erpnepal.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit=False):
		from erpnepal.stock.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
