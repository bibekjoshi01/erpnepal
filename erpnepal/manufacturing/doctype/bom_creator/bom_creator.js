...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "erpnepal.controllers.queries.item_query";
		dialog.show();
	},
...
erpnepal.bom.BomConfigurator = class BomConfigurator extends erpnepal.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new erpnepal.bom.BomConfigurator({ frm: cur_frm }));
