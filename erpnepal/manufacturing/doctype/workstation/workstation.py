...
from erpnepal.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.manufacturing.doctype.workstation_cost.workstation_cost import WorkstationCost
		from erpnepal.manufacturing.doctype.workstation_working_hour.workstation_working_hour import (
