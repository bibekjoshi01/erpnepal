...
from erpnepal.manufacturing.doctype.bom.bom import get_children as get_bom_children
from erpnepal.manufacturing.doctype.bom.bom import validate_bom_no
from erpnepal.manufacturing.doctype.work_order.work_order import get_item_details
...
from erpnepal.stock.get_item_details import get_conversion_factor
from erpnepal.stock.utils import get_or_make_bin
from erpnepal.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from erpnepal.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from erpnepal.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from erpnepal.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from erpnepal.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from erpnepal.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from erpnepal.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def make_work_order(self):
		from erpnepal.manufacturing.doctype.work_order.work_order import get_default_warehouse
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from erpnepal.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from erpnepal.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production
