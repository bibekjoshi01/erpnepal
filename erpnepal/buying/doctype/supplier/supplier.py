...
class Supplier(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.buying.doctype.customer_number_at_supplier.customer_number_at_supplier import (
	...
	def create_primary_contact(self):
		from erpnepal.selling.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from erpnepal.selling.doctype.customer.customer import make_address
