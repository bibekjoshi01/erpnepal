...
from erpnepal.accounts.party import get_party_account_currency, get_party_details
from erpnepal.buying.utils import validate_for_items
from erpnepal.controllers.buying_controller import BuyingController
from erpnepal.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from erpnepal.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
