...
def task(doc_name, from_doctype, to_doctype):
	from erpnepal.accounts.doctype.payment_entry import payment_entry
	from erpnepal.accounts.doctype.purchase_invoice import purchase_invoice
	from erpnepal.accounts.doctype.sales_invoice import sales_invoice
	from erpnepal.buying.doctype.purchase_order import purchase_order
	from erpnepal.buying.doctype.supplier_quotation import supplier_quotation
	from erpnepal.selling.doctype.quotation import quotation
	from erpnepal.selling.doctype.sales_order import sales_order
	from erpnepal.stock.doctype.delivery_note import delivery_note
	from erpnepal.stock.doctype.purchase_receipt import purchase_receipt
