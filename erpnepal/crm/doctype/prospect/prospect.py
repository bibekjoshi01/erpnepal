...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from erpnepal.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
