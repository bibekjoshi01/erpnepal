...
from erpnepal.accounts.party import set_taxes
from erpnepal.controllers.selling_controller import SellingController
from erpnepal.crm.utils import CRMNote, copy_comments, link_communications, link_open_events
from erpnepal.selling.doctype.customer.customer import parse_full_name
...
def get_lead_details(lead, posting_date=None, company=None, doctype=None):
	...
	from erpnepal.accounts.party import set_address_details
