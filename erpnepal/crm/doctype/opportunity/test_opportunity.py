...
from erpnepal.crm.doctype.lead.lead import make_customer
from erpnepal.crm.doctype.lead.test_lead import make_lead
from erpnepal.crm.doctype.opportunity.opportunity import make_quotation
from erpnepal.crm.utils import get_linked_communication_list
from erpnepal.tests.utils import ERPNepalTestSuite


class TestOpportunity(ERPNepalTestSuite):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
