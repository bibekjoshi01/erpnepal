...
erpnepal.accounts.taxes.setup_tax_validations("Sales Taxes and Charges Template");
erpnepal.accounts.taxes.setup_tax_filters("Sales Taxes and Charges");
erpnepal.pre_sales.set_as_lost("Quotation");
...
erpnepal.selling.QuotationController = class QuotationController extends erpnepal.selling.SellingController {
	onload(doc, dt, dn) {
	...
	set_dynamic_field_label() {
		if (this.frm.doc.quotation_to == "Customer") {
			...
			this.frm.fields_dict.party_name.get_query = function () {
				return { query: "erpnepal.controllers.queries.lead_query" };
			};
	...
	get_lead_details() {
		...
		frappe.call({
			method: "erpnepal.crm.doctype.lead.lead.get_lead_details",
			args: {
...
cur_frm.script_manager.make(erpnepal.selling.QuotationController);
