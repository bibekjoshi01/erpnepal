...
from erpnepal.stock.utils import get_valid_serial_nos
...
class InstallationNote(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.selling.doctype.installation_note_item.installation_note_item import (
	...
	def validate(self):
		...
		from erpnepal.controllers.selling_controller import set_default_income_account_for_item
