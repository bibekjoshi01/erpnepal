...
from erpnepal.accounts.party import get_party_account
from erpnepal.controllers.selling_controller import SellingController
from erpnepal.manufacturing.doctype.blanket_order.blanket_order import (
...
from erpnepal.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from erpnepal.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from erpnepal.accounts.doctype.pricing_rule.utils import update_coupon_code_count
	...
	def update_subcontracting_order_status(self):
		from erpnepal.subcontracting.doctype.subcontracting_inward_order.subcontracting_inward_order import (
...
def create_pick_list(source_name, target_doc=None):
	from erpnepal.stock.doctype.packed_item.packed_item import is_product_bundle
