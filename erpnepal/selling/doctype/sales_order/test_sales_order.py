...
from erpnepal.accounts.test.accounts_mixin import AccountsTestMixin
from erpnepal.controllers.accounts_controller import InvalidQtyError, get_due_date, update_child_qty_rate
from erpnepal.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from erpnepal.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
	make_maintenance_visit,
)
from erpnepal.manufacturing.doctype.blanket_order.test_blanket_order import make_blanket_order
from erpnepal.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
from erpnepal.selling.doctype.sales_order.sales_order import (
	WarehouseRequired,
	create_pick_list,
	make_delivery_note,
...
from erpnepal.stock.get_item_details import get_bin_details
...
class TestSalesOrder(AccountsTestMixin, IntegrationTestCase):
	...
	def test_drop_shipping(self):
		from erpnepal.buying.doctype.purchase_order.purchase_order import update_status
		from erpnepal.selling.doctype.sales_order.sales_order import (
			make_purchase_order,
		)
		from erpnepal.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from erpnepal.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from erpnepal.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from erpnepal.controllers.item_variant import create_variant
		from erpnepal.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from erpnepal.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from erpnepal.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from erpnepal.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from erpnepal.stock.doctype.material_request.material_request import raise_work_orders
	...
	@patch(
		...
		"erpnepal.accounts.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	def test_sales_order_advance_payment_status(self, mocked_get_payment_url):
		from erpnepal.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from erpnepal.accounts.doctype.payment_request.payment_request import make_payment_request
	...
	def test_pick_list_for_batch(self):
		from erpnepal.stock.doctype.pick_list.pick_list import create_delivery_note
