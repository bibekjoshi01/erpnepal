...
from erpnepal.exceptions import PartyDisabled, PartyFrozen
from erpnepal.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from erpnepal.tests.utils import create_test_contact_and_address
...
class TestCustomer(IntegrationTestCase):
	...
	def test_customer_credit_limit_after_submit(self):
		from erpnepal.controllers.accounts_controller import update_child_qty_rate
		from erpnepal.selling.doctype.sales_order.test_sales_order import make_sales_order
