...
import erpnepal
from erpnepal.assets.doctype.asset.asset import get_asset_value_after_depreciation
...
from erpnepal.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from erpnepal.assets.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from erpnepal.assets.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from erpnepal.assets.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
