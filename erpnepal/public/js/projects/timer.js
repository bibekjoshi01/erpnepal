frappe.provide("erpnepal.timesheet");

erpnepal.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	erpnepal.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

erpnepal.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
